...
With that being said, throughout the two years I've been using it, the model predicts the correct outcome (win/loss) of a given game with about 70% accuracy. When it comes to the spread, it's accuracy is 50/50, so, completely unreliable. Then again, predicting the spread is insanely difficult, and I have yet to simulate fruitful betting strategies around the spread. However, there have been some cool papers discussing how to optimally bet the spread. More recently, I've read this one: 
